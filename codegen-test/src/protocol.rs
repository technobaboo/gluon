...
pub enum TestEnum {
    ...
    WeirdStuff { spatial: spatial::SpatialRef },
    EmptyVairant {},
}
    ...
    fn read(
        ...
        Ok(
            match data.read_u16()? {
                ...
                1u16 => {
                    let spatial = gluon_wire::GluonConvertable::read(data)?;
                    TestEnum::WeirdStuff { spatial }
                }
